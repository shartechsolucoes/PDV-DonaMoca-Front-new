		...
		<div className="row mb-4">
			...
			<div className="header-page row mb-4">
				<div className="col-3">
					...
					<p className="url-page">Dashboard / Dashboard</p>
				</div>
			...
			<div className="row mb-3">
				{[
					...
					{ title: "Páginas Visualizadas", content: "166.248", icon: 'view', info: '', footer:'' },
					{ title: "Matérias Publicadas", content: "254", icon: 'view', info: '', footer:''  },
				].map((c, i) => (
					<div className="col-12 col-md-6 col-lg-3 mt-3 mt-lg-0" key={i}>
